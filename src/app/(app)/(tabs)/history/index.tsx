...
// Define the type for the workouts query result directly here
...
type Workout = GetWorkoutsQueryResult[number];
      ...
      >
        ...
        {workouts.length === 0 ? (
          <View className="bg-white rounded-2xl p-8 items-center ">
            ...
            <Text className="text-gray-900 mt-4 text-xl font-semibold">
              ...
              >
                ...
                <View className="flex-row items-center justify-between mb-4">
                  <View className="flex-1">
                    ...
                    <View className="bg-blue-100 rounded-full w-12 h-12
