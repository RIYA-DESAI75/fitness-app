...
export default function ExerciseSelectionModal({
  ...
  const fetchExercises = async () => {
    try {
      // Fetch exercises from your data source (e.g., API or local storage)
      // For now, we'll use a placeholder array
      const exercises = await client.fetch(exercisesQuery); // Replace with actual fetch logic
  ...
  const handleExercisePress = (exercise: Exercise) => {
    // Directly add the exercise to the workout
    ...
    >
      <SafeAreaView className="flex-1 bg-white">
        ...
        <View className="bg-white px-4 pt-4 pb-6 shadow-sm border-b border-gray-100">
          ...
          <Text className="text-gray-600 mb-4">Tap any exercise to add it to your workout</Text>
            ...
            <View className="flex-1 items-center justify-center py-20">
              ...
              <Text className="text-gray-400 text-sm mt-2">
                {searchQuery
                  ...
                  : "Please wait a moment while we load exercises"}
              </Text>
            </View>
          }
        />
